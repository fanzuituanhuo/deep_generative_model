...
| 文件 | 主题 | 说明 |
|------|------|------|
| `chap1_intro.tex` / `chapter1_en.tex` | 深度生成模型简介 | 基础概念、生成建模框架与背景知识 |
| `chap2_vae.tex` / `chapter2_vae_en.tex` | 变分自编码器（VAE） | 变分推断、ELBO、重参数化技巧等 |
| `chap3_ddpm.tex` / `chapter3_ddpm_en.tex` | 去噪扩散概率模型（DDPM） | 前向/反向扩散、训练与采样 |
| `chapter4_score_based_en.tex` | 基于 Score 的生成模型 | Score Matching、Langevin Dynamics、NCSN 等 |
...
├── chapter1_en.tex                 # 第一章英文版
├── chap2_vae.tex                   # 第二章 LaTeX 源文件
├── chapter2_vae_en.tex             # 第二章英文版
├── chap3_ddpm.tex                  # 第三章 LaTeX 源文件
├── chapter3_ddpm_en.tex            # 第三章英文版
├── chapter4_score_based_en.tex     # 第四章：Score-Based 模型
...
# 或
xelatex chapter4_score_based_en.tex
```
